...
void InitGame(void)
{
	...
	SetUi(D3DXVECTOR3(SCREEN_WIDTH * 0.7f, 100.0f, 0.0f), 200.0f, 60.0f, 3, D3DXVECTOR3(0.0f, 1.0f, 0.0f));
	SetUi(D3DXVECTOR3(SCREEN_WIDTH * 0.7f, 300.0f, 0.0f), 200.0f, 60.0f, 3, D3DXVECTOR3(0.0f, 1.0f, 0.0f));
	SetUi(D3DXVECTOR3(SCREEN_WIDTH * 0.7f, 500.0f, 0.0f), 200.0f, 60.0f, 3, D3DXVECTOR3(0.0f, 1.0f, 0.0f));
